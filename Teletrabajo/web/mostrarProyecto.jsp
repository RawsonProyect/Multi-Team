            ...
            <div id="content">
                ...
                <div class="col-md-8 order-md-3">
                    <section> 
                        ...
                        %>
                        <legend class ="title">Ver Proyecto</legend>


                        <div class="row">
                            <div class="col">
                                <label for="Proy_Name">Nombre Proyecto:</label>
                                <input type="text" class="form-control coloreado" id="Proy_Name" placeholder="" value="<%=nombre%>" required disabled>

                            </div>
                            <div class="col" >
                                <label for="Proy_Name">Nombre Cliente:</label>
                                <input type="text" class="form-control coloreado" value="<%=nombreCliente%>" disabled>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <!-- <div id="fecha"class="input-group date"data-provide="datepicker"> -->
                                <input type="text" id ="FechaIniPr" value="<%=fechaIP%>" disabled>
                                <!-- </div> -->
                            </div>
                            <div class="col">
                                <label for="FechaFin">Fecha de fin Prevista:</label>
                                <!-- <div class="input-group date" data-provide="datepicker"> -->
                                <input type="text" id ="FechaFinPr" value="<%=fechaFP%>" disabled>
                                <!-- /div> -->
                            </div>
                        </div>		 
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" id ="FechaIni" value="<%=fechaIR%>" disabled>
                                <!-- </div> -->
                            </div>
                            <div class="col">
                                ...
                                <input type="text" id ="FechaFin" value="<%=fechaFR%>" disabled>
                                ...
                                <table align="center" id="tabla_proyectos" class="table table-striped table-hover dt-responsive" cellspacing="0" width="100%"   >
                                    ...
                                    <tbody>
                                        ...
                                        <!--                      <tr class ="tabla_color">
                                                                ...
                                                                <td>15/11/2000</td>
                                                                <td style="text-align: center;"class="form-check">
                                                                    <input class="form-check-input" type="checkbox" value="" id="incidencia1" checked disabled>
                                                                </td>
                                                                <td>Requisito</td>
                                                                <td style="text-align: center;"class="form-check">
                                                            ...
                                                            <tr class ="tabla_color">
                                                                ...
                                                                <td>15/11/2000</td>
                                                                <td style="text-align: center;"class="form-check">
                                                                    <input class="form-check-input" type="checkbox" value="" id="incidencia2"  disabled>
                                                                </td>
                                                                <td>Requisito</td>
                                                                <td style="text-align: center;"class="form-check">
                                                                    <input class="form-check-input" type="checkbox" value="" id="defaultCheck3"  checked disabled>
                                                                </td>
                                                                <td>Descripción</td>
                                                                <td>Ruta</td>
                                                            ...
                                                            <tr class ="tabla_color">
                                                                ...
                                                                <td>15/11/2000</td>
                                                                <td style="text-align: center;"class="form-check">
                                                                    <input class="form-check-input" type="checkbox" value="" id="incidencia3"  disabled>
                                                                </td>
                                                                <td>Requisito</td>
                                                                <td style="text-align: center;"class="form-check">
                    ...
                    <div class="col-md-8 col-xs-8 col-md-offset-7" style="padding-top: 20px;">
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <form action="ListarProyectosServlet" method="post">
                                <a href="editarProyecto.jsp" class="btn btn-warning btn-sm enabled" role="button">Editar</a>
                                <input type="submit" class="btn btn-danger btn-sm enabled" value="Volver">
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <!--                
            <a href="#" class="btn btn-success btn-sm enabled" role="button">Guardar</a>
                -->
