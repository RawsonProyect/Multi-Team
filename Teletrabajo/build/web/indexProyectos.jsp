                ...
                <div id="content">
                    ...
                    <div class="table-responsive-sm">
                        <table id="tabla" class="table table-hover" >
                            ...
                            <tbody>
                                <% List<Proyecto> listProyecto = (List<Proyecto>) session.getAttribute("lista");
                                    for (int i = 0; i < listProyecto.size(); i++) {
                                        Proyecto p = listProyecto.get(i);
                                        int id = p.getIdProyecto();
                                        String nombre = p.getNombre();
                                        Date fechaIni = p.getFir();
                                        String fechaIniS = "";
                                        if (fechaIni != null) {
                                            fechaIniS = new SimpleDateFormat("dd/MM/yyyy").format(fechaIni).toString();
                                        } else {
                                            fechaIniS = "No establecida";
                                        }
                                        Date fechaFin = p.getFfr();
                                        String fechaFinS = "";
                                        if (p.getFfr() != null) {
                                            fechaFinS = new SimpleDateFormat("dd/MM/yyyy").format(p.getFfr()).toString();
                                        } else {

                                            fechaFinS = "No establecida";
                                        }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="icono" name="idProyecto" value=<%=id%> onclick="submit()">
